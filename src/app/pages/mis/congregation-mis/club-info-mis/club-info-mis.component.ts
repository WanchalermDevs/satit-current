...
@Component({
  selector: 'app-club-info-mis',
  templateUrl: './club-info-mis.component.html',
  styleUrls: ['./club-info-mis.component.scss']
})
export class ClubInfoMISComponent implements OnInit {
